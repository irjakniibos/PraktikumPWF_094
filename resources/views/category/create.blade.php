                ...
                <div class="relative p-6 sm:p-8 lg:p-10">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <h2 class="mt-4 text-3xl font-semibold tracking-tight text-white">Add Category</h2>
                            <p class="mt-2 text-sm leading-6 text-slate-300">Create a new category that can be assigned to products.</p>
                        </div>
                    </div>
